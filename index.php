...
.user {
  ...
  width: 100%;
  height: 100vh;
  background: url("https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1428&q=80") no-repeat center;
  ...
  <div class="user_options-container">
    <div class="user_options-text">
      <div class="user_options-unregistered">
        ...
        <p class="user_unregistered-text">Silahkan Registrasi Terlebih Dahulu !</p>
        <button class="user_unregistered-signup" id="signup-button">Sign up</button>
      </div>

      <div class="user_options-registered">
        <h2 class="user_registered-title">Sudah Punya Akun ?</h2>
        <p class="user_registered-text">Apabila Sudah, Silahkan Login !</p>
    ...
    <div class="user_options-forms" id="user_options-forms">
      <div class="user_forms-login">
        ...
        <form method="post" action="action-log.php" class="forms_form">
          <fieldset class="forms_fieldset">
            <div class="forms_field">
              <input type="text" placeholder="Username" name="username" class="forms_field-input" name="username" required autofocus />
            </div>
            <div class="forms_field">
              <input type="password" placeholder="Password" name="password" class="forms_field-input" name="password" required />
            </div>
          </fieldset>
      ...
      <div class="user_forms-signup">
        ...
        <form method="post" action="action-reg.php" enctype="multipart/form-data" class="forms_form">
          <fieldset class="forms_fieldset">
            <div class="forms_field">
              <input type="text" placeholder="Username" name="User" class="forms_field-input" required />
            </div>
            <div class="forms_field">
