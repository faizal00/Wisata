                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        while($tempat = mysqli_fetch_array($query)){
                                            echo "<tr>";
                                            // echo "<td>".$tempat['id']."</td>";
                                            echo "<td>".$tempat['Nama_Tempat']."</td>";
                                            echo "<td>".$tempat['Lokasi']."</td>";
                                            echo "<td>".$tempat['Jenis']."</td>";
                                            echo "<td>
                                            <a href='edit.php?id=".$tempat['id']."'>
                                            <button type='submit' class='btn bg-blue waves-effect' name='hps'>EDIT</button>
                                            </a> ";
                                            echo "</tr>";
                                            echo "";
